...
class Options():
    ...
    def add_optim_options(self):
        ...
        self.parser.add_argument('--hidden_units', type=int, default=768, help='retriver hidden units')
        ...
        self.parser.add_argument('--reference_lr', type=float, default=0.001, help='learning rate')
